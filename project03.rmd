...
Locations are in a separate data dictionary of their own, partially because the BreweryDB API had the locations as their own dictionaries and because there's so much information associated with a location id. The variables in the final locations data dictionary are as follows:
...
descriptions <- c("the id of a particular location (geophysical location)", "the name of a location, usually street name", "the address and number of a location", "the city of the location", "the particular country region the location is in, for the US, southwest for example", "the postal code of the location", "the latitude coordinates of the location", "the longitude coordinates of the location", "the kind of location it is: restuarant vs microbrewery for example", "whether that particular location is the primary location for a particular brewery", "the three character country code of a location", "the brewery id of the brewery associated with this particular location")
locationstable <- data.frame(variables, descriptions)
library(knitr)
kable(locationstable)
```
  
  Finally, I created a styles to categories data dictionary of all the different styles and categories and their mappings, associating styles and style information like the range of alcohol per beer volume content fo that particular style. The variables in this dictionary are:
...
```{r kable, echo=FALSE}
ranges <- c("1.0 - 3.0", "3.0 - 4.5", "4.5 - 7.5", "7.5 - 9.0", "9.0 - 11.0", "11.0 - 14.0", "14.0 - 19.0", "19.0 - 20.0")
colors <- c("Pale yellow", "Medium yellow", "Gold", "Amber", "Copper", "Red/Brown", "Brown", "Black")
srmtable <- data.frame(ranges, colors)
library(knitr)
kable(srmtable, digits=2)
```
